  ...
  return (
    <section className="p-3 rounded-2xl border border-zinc-800" dir="rtl">
      ...
      <div className="flex md:items-center md:flex-row flex-col justify-center gap-x-3 my-2">
        <div className="md:h-[50px] h-[40px] md:w-[30%] w-[60%] bg-black rounded-2xl md:mb-0 mb-3 cursor-pointer px-2 flex items-center justify-between">
      ...
      <p className="text-sm text-zinc-400">
        قیمت :{" "}
        <span className="font-semibold text-[#2cb67d] md:ml-2">10.2 $ </span> معادل{" "}
        <span className="font-semibold text-[#2cb67d] md:mr-2"> 90/000 تومان</span>
      </p>
    </section>
  );
};
